...
CREATE  TABLE "public".user_identity_provider (
                                                  ...
                                                  created_at           timestamp    ,
                                                  updated_at           timestamp    ,
                                                  CONSTRAINT pk_user_identity_provider PRIMARY KEY ( id ),
                                                  CONSTRAINT unq_provider_user_id_provider UNIQUE( provider_user_id, provider ),
                                                  CONSTRAINT unq_user_id_provider UNIQUE (user_id, provider),
                                                  CONSTRAINT fk_user_identity_provider FOREIGN KEY ( user_id ) REFERENCES "public".t_user( id )
);

CREATE UNIQUE INDEX idx_provider_user_id ON "public".user_identity_provider ( provider_user_id );
